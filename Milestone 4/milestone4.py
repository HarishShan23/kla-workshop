...
milestone4_source = 'Source.txt'
milestone4_poi = 'POI.txt'
milestone4_output = 'MileStone4_Result.txt'
...
with open(milestone4_source, 'r') as rf:
    data = rf.read()
...
with open(milestone4_poi, 'r') as rf_poi:
...
with open(milestone4_output, 'w') as rw:
    rw.write(header)
